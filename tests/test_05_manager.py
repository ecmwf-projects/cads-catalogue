...
def test_load_resource_for_object_storage() -> None:
    ...
    assert res == {
        "adaptor": os.path.join(folder_path, "json-config", "adaptor.json"),
...
def test_load_resource_from_folder() -> None:
    ...
    expected_resource = {
        ...
        "variables": [
            {
                "description": "Eastward component of the 10m wind. It is the horizontal "
                "speed of air moving towards the east, at a height of ten "
                ...
                "vegetation and buildings that are represented only on "
                "average in the ECMWF Integrated Forecasting System. This "
                "variable can be combined with the V component of 10m wind to "
                "give the speed and direction of the horizontal 10m wind.",
                "id": "10m_u_component_of_wind",
                "label": "10m u-component of wind",
                "units": "m s^-1",
            },
            {
                "description": "Northward component of the 10m wind. It is the horizontal "
                ...
                "vegetation and buildings that are represented only on "
                "average in the ECMWF Integrated Forecasting System. This "
                "variable can be combined with the U component of 10m wind to "
                "give the speed and direction of the horizontal 10m wind.",
            ...
            {
                "description": "Temperature to which the air, at 2 metres above the surface "
                "of the Earth, would have to be cooled for saturation to "
                "occur.It is a measure of the humidity of the air. Combined "
                "with temperature and pressure, it can be used to calculate "
                "the relative humidity. 2m dew point temperature is "
                "calculated by interpolating between the lowest model level "
                "and the Earth's surface, taking account of the atmospheric "
                "conditions. Temperature measured in kelvin can be converted "
            ...
            {
                "description": "Temperature of air at 2m above the surface of land, sea or "
                "in-land waters. 2m temperature is calculated by "
            ...
            {
                "description": "The amount of evaporation from bare soil at the top of the "
                "land surface. This variable is accumulated from the "
            ...
            {
                "description": "Amount of evaporation from surface water storage like lakes "
            ...
            {
                "description": "The amount of evaporation from the canopy interception "
            ...
            {
                "description": "Amount of evaporation from vegetation transpiration. This "
                "has the same meaning as root extraction i.e. the amount of "
                "water extracted from the different soil layers. This "
                "variable is accumulated from the beginning of the forecast "
            ...
            {
                "description": "Is a measure of the reflectivity of the Earth's surface. It "
                "is the fraction of solar (shortwave) radiation reflected by "
                "Earth's surface, across the solar spectrum, for both direct "
                "and diffuse radiation. Values are between 0 and 1. "
                "Typically, snow and ice have high reflectivity with albedo "
                "values of 0.8 and above, land has intermediate values "
                "between about 0.1 and 0.4 and the ocean has low values of "
                "0.1 or less. Radiation from the Sun (solar, or shortwave, "
                "radiation) is partly reflected back to space by clouds and "
                "particles in the atmosphere (aerosols) and some of it is "
                "absorbed. The rest is incident on the Earth's surface, where "
                "some of it is reflected. The portion that is reflected by "
                "the Earth's surface depends on the albedo. In the ECMWF "
            ...
            {
                "description": "Temperature of water at the bottom of inland water bodies "
            ...
            },
            {
                ...
                "reservoirs and rivers) and coastal waters. The ECMWF "
                "Integrated Forecasting System (IFS) represents the formation "
                "and melting of ice on inland water bodies (lakes, reservoirs "
                "and rivers) and coastal water. A single ice layer is "
                "represented. This parameter is the thickness of that ice "
                "layer.",
                "id": "lake_ice_depth",
            ...
            {
                "description": "The temperature of the uppermost surface of ice on inland "
            ...
            {
                "description": "The thickness of the upper most layer of an inland water "
                "body (lake, reservoirs, and rivers) or coastal waters that "
                "is well mixed and has a near constant temperature with depth "
                "(uniform distribution of temperature). The ECMWF Integrated "
            ...
            },
            {
                ...
                "bodies (lakes, reservoirs and rivers) or coastal waters) "
                "that is well mixed. The ECMWF Integrated Forecasting System "
                ...
                "water below. Mixing can also occur through the action of "
                "wind on the surface of the lake. Temperature measured in "
            ...
            {
                "description": "This parameter describes the way that temperature changes "
                "with depth in the thermocline layer of inland water bodies "
                "(lakes, reservoirs and rivers) and coastal waters. It is "
                "used to calculate the lake bottom temperature and other "
                "lake-related parameters. The ECMWF Integrated Forecasting "
                "System represents inland and coastal water bodies with two "
                "layers in the vertical, the mixed layer above and the "
            ...
            {
                "description": "The mean temperature of total water column in inland water "
                "bodies (lakes, reservoirs and rivers) and coastal waters. "
                "The ECMWF Integrated Forecasting System represents inland "
                "water bodies with two layers in the vertical, the mixed "
                "layer above and the thermocline below where temperature "
                "changes with depth. This parameter is the mean over the two "
                "layers. Temperature measured in kelvin can be converted to "
            ...
            {
                "description": "One-half of the total green leaf area per unit horizontal "
            ...
            },
            {
                ...
                "requirements, the method can give unrealistic results in "
                "arid conditions due to too strong evaporation forced by dry "
                "air. Note that in ERA5-Land pev is computed as an open water "
            ...
            {
                "description": "Some water from rainfall, melting snow, or deep in the soil, "
                ...
                "simply called 'runoff'. This variable is the total amount of "
                "water accumulated from the beginning of the forecast time to "
                "the end of the forecast step. The units of runoff are depth "
                "in metres. This is the depth the water would have if it were "
                ...
                "than averaged over a grid square area.  Observations are "
                "also often taken in different units, such as mm/day, rather "
                "than the accumulated metres produced here. Runoff is a "
                "measure of the availability of water in the soil, and can, "
                "for example, be used as an indicator of drought or flood. "
                "More information about how runoff is calculated is given in "
                "the IFS Physical Processes documentation.",
                "id": "runoff",
                "label": "Runoff",
                "units": "m",
            },
            {
                "description": "Amount of water in the vegetation canopy and/or in a thin "
            ...
            {
                "description": "Temperature of the surface of the Earth. The skin "
                "temperature is the theoretical temperature that is required "
                "to satisfy the surface energy balance. It represents the "
                "temperature of the uppermost surface layer, which has no "
                "heat capacity and so can respond instantaneously to changes "
                "in surface fluxes. Skin temperature is calculated "
                "differently over land and sea. Temperature measured in "
                "kelvin can be converted to degrees Celsius (°C) by "
                "subtracting 273.15.",
                "id": "skin_temperature",
            ...
            {
                "description": "It is defined as the fraction of solar (shortwave) radiation "
            ...
            {
                "description": "It represents the fraction (0-1) of the cell / grid-box "
                "occupied by snow (similar to the cloud cover fields of "
                "ERA5).",
                "id": "snow_cover",
                "label": "Snow cover",
                "units": "%",
            ...
            {
                "description": "Mass of snow per cubic metre in the snow layer. The ECMWF "
            ...
            {
                "description": "Instantaneous grib-box average of the snow thickness on the "
            ...
            {
                "description": "Depth of snow from the snow-covered area of a grid box. Its "
                "units are metres of water equivalent, so it is the depth the "
                "water would have if the snow melted and was spread evenly "
                "over the whole grid box. The ECMWF Integrated Forecast "
                "System represents snow as a single additional layer over the "
            ...
            {
                "description": "Evaporation from snow averaged over the grid box (to find "
                "flux over snow, divide by snow fraction). This variable is "
                "accumulated from the beginning of the forecast time to the "
                "end of the forecast step.",
                "id": "snow_evaporation",
            ...
            },
            {
                ...
                "surface. It consists of snow due to the large-scale "
                "atmospheric flow (horizontal scales greater than around a "
                "few hundred metres) and convection where smaller scale areas "
                "(around 5km to a few hundred kilometres) of warm air rise. "
                "If snow has melted during the period over which this "
                "variable was accumulated, then it will be higher than the "
                "snow depth. This variable is the total amount of water "
                "accumulated from the beginning of the forecast time to the "
                "end of the forecast step. The units given measure the depth "
                "the water would have if the snow melted and was spread "
                "evenly over the grid box. Care should be taken when "
                "comparing model variables with observations, because "
            ...
            {
                "description": "Melting of snow averaged over the grid box (to find melt "
            ...
            {
                "description": "Temperature of the soil in layer 1 (0 - 7 cm) of the ECMWF "
            ...
            {
                "description": "Temperature of the soil in layer 2 (7 -28cm) of the ECMWF "
            ...
            {
                "description": "Temperature of the soil in layer 3 (28-100cm) of the ECMWF "
                "Integrated Forecasting System.",
            ...
            {
                "description": "Temperature of the soil in layer 4 (100-289 cm) of the ECMWF "
                "Integrated Forecasting System.",
            ...
            },
            {
                ...
                "either over the surface (surface runoff), or under the "
                "ground (sub-surface runoff) and the sum of these two is "
                "simply called 'runoff'. This variable is accumulated from "
                "the beginning of the forecast time to the end of the "
                "forecast step. The units of runoff are depth in metres. This "
                ...
                "square area.  Observations are also often taken in different "
                "units, such as mm/day, rather than the accumulated metres "
                "produced here. Runoff is a measure of the availability of "
                "water in the soil, and can, for example, be used as an "
                "indicator of drought or flood. More information about how "
            ...
            {
                "description": "Exchange of latent heat with the surface through turbulent "
            ...
            {
                "description": "Amount of solar radiation (also known as shortwave "
                "radiation) reaching the surface of the Earth (both direct "
                "and diffuse) minus the amount reflected by the Earth's "
                "surface (which is governed by the albedo).Radiation from the "
                ...
                "the surface net solar radiation. This variable is "
                "accumulated from the beginning of the forecast time to the "
            ...
            {
                "description": "Net thermal radiation at the surface. Accumulated field from "
                "the beginning of the forecast time to the end of the "
                "forecast step. By model convention downward fluxes are "
                "positive.",
            ...
            {
                "description": "Pressure (force per unit area) of the atmosphere on the "
                ...
                "temperature to calculate air density. The strong variation "
                "of pressure with altitude makes it difficult to see the low "
                "and high pressure systems over mountainous areas, so mean "
                "sea level pressure, rather than surface pressure, is "
                "normally used for this purpose. The units of this variable "
                "are Pascals (Pa). Surface pressure is often measured in hPa "
                "and sometimes is presented in the old units of millibars, mb "
                "(1 hPa = 1 mb = 100 Pa).",
                "id": "surface_pressure",
            ...
            },
            {
                ...
                "be used as an indicator of drought or flood. More "
                "information about how runoff is calculated is given in the "
            ...
            },
            {
                ...
                "governed by the difference in temperature between the "
                "surface and the overlying atmosphere, wind speed and the "
                "surface roughness. For example, cold air overlying a warm "
                "surface would produce a sensible heat flux from the land (or "
                "ocean) into the atmosphere. This is a single level variable "
                "and it is accumulated from the beginning of the forecast "
                "time to the end of the forecast step. The units are joules "
                "per square metre (J m^-2). To convert to watts per square "
                "metre (W m^-2), the accumulated values should be divided by "
                "the accumulation period expressed in seconds. The ECMWF "
                "convention for vertical fluxes is positive downwards.",
            ...
            {
                "description": "Amount of solar radiation (also known as shortwave "
                "radiation) reaching the surface of the Earth. This variable "
                "comprises both direct and diffuse solar radiation. Radiation "
                "from the Sun (solar, or shortwave, radiation) is partly "
                "reflected back to space by clouds and particles in the "
                "atmosphere (aerosols) and some of it is absorbed.  The rest "
                "is incident on the Earth's surface (represented by this "
                "variable). To a reasonably good approximation, this variable "
                "is the model equivalent of what would be measured by a "
                "pyranometer (an instrument used for measuring solar "
                "radiation) at the surface. However, care should be taken "
                "when comparing model variables with observations, because "
                "observations are often local to a particular point in space "
                "and time, rather than representing averages over a  model "
                "grid box and model time step. This variable is accumulated "
                "from the beginning of the forecast time to the end of the "
                "forecast step. The units are joules per square metre (J "
                "m^-2). To convert to watts per square metre (W m^-2), the "
                "accumulated values should be divided by the accumulation "
                "period expressed in seconds. The ECMWF convention for "
            ...
            {
                "description": "Amount of thermal (also known as longwave or terrestrial) "
            ...
            {
                "description": "This variable gives the temperature of the snow layer from "
            ...
            {
                "description": "Accumulated amount of water that has evaporated from the "
                "Earth's surface, including a simplified representation of "
                "transpiration (from vegetation), into vapour in the air "
                "above. This variable is accumulated from the beginning of "
                "the forecast to the end of the forecast step. The ECMWF "
            ...
            {
                "description": "Accumulated liquid and frozen water, including rain and "
                "snow, that falls to the Earth's surface. It is the sum of "
                ...
                "atmosphere is warmer and less dense than the air above, so "
                "it rises). Precipitation variables do not include fog, dew "
                "or the precipitation that evaporates in the atmosphere "
                "before it lands at the surface of the Earth. This variable "
                "is accumulated from the beginning of the forecast time to "
                "the end of the forecast step. The units of precipitation are "
            ...
            },
            {
                ...
                "volumetric soil water is associated with the soil texture "
                "(or classification), soil depth, and the underlying "
                "groundwater level.",
            ...
            {
                "description": "Volume of water in soil layer 2 (7 -28 cm) of the ECMWF "
                "Integrated Forecasting System.",
            ...
            {
                "description": "Volume of water in soil layer 3 (28-100 cm) of the ECMWF "
                "Integrated Forecasting System.",
            ...
            {
                "description": "Volume of water in soil layer 4 (100-289 cm) of the ECMWF "
                "Integrated Forecasting System.",
    ...
    expected_resource = {
        "abstract": "",
        "adaptor": os.path.join(resource_folder_path, "json-config", "adaptor.json"),
