...
def test_update_catalogue(
    ...
    ## - old resources are skipped (hash)
    ## - relationships of resources are ok
    ## - verify licences and messages are skipped

    # 7. run without excluding anything -------------------------------------------------
    ## - the excluded dataset is loaded
    ## - the other old datasets are skipped (hash)
    ## - relationships of resources are ok
    ## - verify licences and messages are skipped

    # 8. run again -----------------------------------------------------------------------
    ## all is skipped (git hash)

    # 9. change a dataset and run again with force ---------------------------------------
    ## - nothing is skipped
    ## - the dataset change is reset
